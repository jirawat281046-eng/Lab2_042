		...
		<tr>
			<td width="1007" bgcolor="#FFFFFF">
				<p>
					...
					เหมาะสำหรับ <br> นักศึกษา คนทำงาน ใกล้แหล่งชุมชน และ ห้างสรรพสินค้า BigC , Lotus
				<p>
					ห้องพักทันสมัย เฟอร์นิเจอร์อย่างดี และสุขภัณฑ์ครบครัน มีสิ่งอำนวยความสะดวกมากมาย
					อาทิ WIFI อินเทอร์เน็ตค มีพัดลม เครื่องปรับอากาศ มีทีวี และตู้เย็น
			
				<p>
					เชิญชมห้องตัวอย่าง ได้ทุกวัน <a href=amit.php>ติดต่อสอบถาม</a>	
			</td>
			<td width="190" bgcolor="#390db3"><ul>
